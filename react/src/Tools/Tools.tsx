...
function Tools() {
    ...
    return (
        <div className="tools" onClick={() => console.log("ты в инструментах")}>
          ...
          <div key={4} className={"tool tool_text-obj "+(activeTool == 1 ? "tool_active" : "")} onClick={() => {setActiveTool(1); setGlobalActiveTool(1); console.log('Текст')}}>
          ...
          <div key={6} className={"tool tool_shape-obj "+(activeTool == 3 ? "tool_active" : "")} onClick={() => {setActiveTool(3); setGlobalActiveTool(3); console.log('Фигура')}}>
